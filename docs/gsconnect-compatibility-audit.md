...
| --- | --- |
| Notifications | Full GSConnect parity still requires desktop notification mirroring to the phone, notification action activation, inline reply bridging, and cancellation sync. |
