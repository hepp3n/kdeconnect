...
plugin-mousepad-desc = Allow your phone to control the desktop pointer and keyboard.
...
plugin-presenter-name = Presenter
plugin-presenter-desc = Use your phone as a presentation pointer.
...
plugin-sftp-name = Device Filesystem
plugin-sftp-desc = Browse files on your phone over SFTP.
