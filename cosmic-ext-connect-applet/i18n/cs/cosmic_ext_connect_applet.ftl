...
plugin-mousepad-name = Vzdálený vstup
plugin-mousepad-desc = Umožní telefonu ovládat ukazatel a klávesnici počítače.
...
plugin-presenter-name = Prezentace
plugin-presenter-desc = Umožní použít telefon jako ukazatel při prezentaci.
